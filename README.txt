...
Your plugin LayerCombinations was created in:
    C:\Users\Olivier\.qgis\python\plugins\LayerCombinations
...
What's Next:
  ...
  * Customize it by editing the implementation file:
         layercombinations.py

  * Create your own custom icon, replacing the default icon.png

  * Modify your user interface by opening layercombinations.ui
