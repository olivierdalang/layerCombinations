...
# translation
SOURCES = layercombinations.py ui_layercombinations.py __init__.py layercombinationsdialog.py
#TRANSLATIONS = i18n/layercombinations_en.ts
TRANSLATIONS = 

# global

PLUGINNAME = layercombinations

PY_FILES = layercombinations.py layercombinationsdialog.py __init__.py

EXTRAS = icon.png 

UI_FILES = ui_layercombinations.py
